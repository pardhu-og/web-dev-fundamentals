...
export default function ResponsivePricing () {
    return (
        <div className="bg-red-100 font-mono pt-24  min-h-screen h-auto flex flex-col justify-start items-center gap-8">
            <div className=""><h1 className="text-5xl  italic bold">Nirvana</h1></div>
            <div className="  bg-green-100 p-4 mb-2 w-full max-w-screen-md shadow-xl rounded-xl">
            <h2 className="text-center text-3xl italic   ">Select a Plan</h2>
            <div className="flex flex-col gap-4 sm:flex-row justify-evenly items-center m-4 p-2 h-fit">
